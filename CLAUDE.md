...
├── frontend/         # Patient-facing React app (port 3180)
├── admin-frontend/   # Admin/Doctor React app (port 3181)
...
- **DB**: PostgreSQL 16 (port 5495, db: dentistry, user: postgres, password: dentistry_pg_2026)
...
uvicorn app.main:app --reload --port 8870
