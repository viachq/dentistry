...
# ── Database (Docker) ──
if (Test-Port 5495) {
    Write-Host "[OK] PostgreSQL already on port 5495" -ForegroundColor Green
} else {
    ...
    Write-Host "[OK] PostgreSQL ready on port 5495" -ForegroundColor Green
}
...
Write-Host "  PostgreSQL  localhost:5495"
